 ...
 * @module vec-struct
 */
import { Vec as BaseVec, StructDef, Struct, ReadonlyFloat64Array } from "./core";
export { Vec } from "./core";
export type { CursorConstructor, VecCursor, Primitive, Bool, Char, Num, VecPrimitive, ReadonlyFloat64Array, Struct, StructDef, SortCompareCallback, MapCallback, MapvCallback, ForEachCallback, ReduceCallback, TruthyIterCallback } from "./core";
/**
...
export interface VecClass<T extends StructDef> {
     ...
     * method of ```Worker```s.
     *
     * @param {ReadonlyFloat64Array} memory memory
     ...
     * ```
     */
    fromMemory(memory: ReadonlyFloat64Array): BaseVec<T>;
    /**
     * An alternate constructor for vecs.
