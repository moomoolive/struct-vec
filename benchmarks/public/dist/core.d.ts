...
export declare const MEMORY_LAYOUT: Float64ArrayConstructor;
...
export declare class Vec<T extends StructDef> {
    ...
    */
     ...
     * ```
     */
    static fromMemory<U extends StructDef>(memory: ReadonlyFloat64Array): Vec<U>;
    /**
     * An alternate constructor for vecs.
     ...
     * ```
     */
    constructor(initialCapacity?: number, memory?: ReadonlyFloat64Array);
    /**
     ...
     * The value is between 0 and ```Number.MAX_SAFE_INTEGER```
     * (about 2^53),
     ...
     */
    get memory(): ReadonlyFloat64Array;
    set memory(newMemory: ReadonlyFloat64Array);
    /**
