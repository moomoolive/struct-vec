 ...
 */
export class NamedJs extends Vec {
    static def = {"x":"bool","y":"f32","z":"char"}
    static elementSize = 3
    static Cursor = class NamedJsCursor {
        ...
        get ref() { return new NamedJs.Cursor(this.self, this._viewingIndex) }
    ...
    get cursorDef() { return NamedJs.Cursor }
}